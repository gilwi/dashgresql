...
def check_pg_connection(db_instance):
    """
    Attempts a real connection to the PostgreSQL server.
    Returns a dict with status, connection count, and error if any.
    """
    try:
        ...
        # Query live connection count from pg_stat_activity
